...
const (
	Identity_RegisterIdentity_FullMethodName = "/cms.apis.v0.Identity/RegisterIdentity"
)
...
func (c *identityClient) RegisterIdentity(ctx context.Context, in *RegisterIdentityRequest, opts ...grpc.CallOption) (*RegisterIdentityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterIdentityResponse)
	err := c.cc.Invoke(ctx, Identity_RegisterIdentity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedIdentityServer) RegisterIdentity(context.Context, *RegisterIdentityRequest) (*RegisterIdentityResponse, error) {
...
func _Identity_RegisterIdentity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RegisterIdentityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IdentityServer).RegisterIdentity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Identity_RegisterIdentity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IdentityServer).RegisterIdentity(ctx, req.(*RegisterIdentityRequest))
	}
...
var Identity_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "cms.apis.v0.Identity",
	HandlerType: (*IdentityServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "RegisterIdentity",
			Handler:    _Identity_RegisterIdentity_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "cms/apis/v0/identity.proto",
}
